  ...
  return (
    <div className="flex items-center justify-between mb-6">
      <div className="flex items-center gap-2">
        ...
        <h1 className="text-xl font-bold text-gray-900">Shipping Provider</h1>
      </div>
      <button
        onClick={() => navigate('/third-party-integration/shipping-provider/add')}
...
export default ShippingProviderHeader;
