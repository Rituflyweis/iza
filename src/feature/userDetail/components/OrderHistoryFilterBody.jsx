...
const OrderHistoryFilterBody = ({ filterData, onFilterChange }) => {
  const months = [
  ...
  const handlePaymentStatusChange = (paymentStatus) => {
    const newPaymentStatus = filterData.paymentStatus.includes(paymentStatus)
      ? filterData.paymentStatus.filter(p => p !== paymentStatus)
      : [...filterData.paymentStatus, paymentStatus];
    onFilterChange({ ...filterData, paymentStatus: newPaymentStatus });
  };
  ...
  return (
    <Box>
      ...
      <FilterSection title="Payment Status">
        <CheckboxOption
          label="Paid"
          checked={filterData.paymentStatus.includes('Paid')}
          onChange={() => handlePaymentStatusChange('Paid')}
        />
        <CheckboxOption
          label="Refunded"
          checked={filterData.paymentStatus.includes('Refunded')}
          onChange={() => handlePaymentStatusChange('Refunded')}
        />
      </FilterSection>
...
export default OrderHistoryFilterBody;
