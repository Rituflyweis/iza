  ...
  return (
    <div className="">
      <div className="mb-6 flex items-center gap-3">
        ...
        <div>
          <h1 className="text-xl font-semibold text-gray-900">Add New Loyalty Program</h1>
          <p className="text-sm text-gray-400">Configure tiers, points and benefits</p>
        </div>
      </div>
      ...
      <div className="space-y-6 rounded-3xl border border-gray-200 bg-white p-6 shadow-sm">
        ...
        <label className="flex flex-col gap-2">
          <span className="text-sm font-semibold text-gray-700">Points Price</span>
          <input
            type="text"
